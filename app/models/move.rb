class Move < ApplicationRecord
  ...
  scope :available_next, ->(previous_move_ending_position_id) do
    ## Try to get all moves with can start from a certain position
    joins(:possible_move_start_positions).merge(PossibleMoveStartPosition.get_info_from_join(previous_move_ending_position_id))
  end
end
